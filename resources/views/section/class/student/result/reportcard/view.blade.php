    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12 text text-center">
                ...
                <b>REPORT SHEET FOR SECOND TERM {{$sectionClassStudentTerm->academicSessionTerm->academicSession->name}} ACADEMIC SESSION</b><hr style="background-color: orange; height: 3px;">
            </div>
