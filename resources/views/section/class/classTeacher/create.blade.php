<x-app-layout>
    ...
    @endsection
    @section('breadcrumb')
       {{Breadcrumbs::render('dashboard.section.class-teacher.create', $sectionClass)}}
    @endsection
    @section('content')
    <div class="row">
    ...
    <div class="card shadow">
        ...
        <form action="{{route('dashboard.section.class-teacher.register',[$sectionClass->id])}}" method="post">
                @csrf
