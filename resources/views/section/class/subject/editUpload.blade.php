  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('dashboard.section.class.subject.update.upload',[$sectionClassSubject->sectionClass->id,$sectionClassSubject->id,$upload->academicSessionTerm->term->id,$upload->id])}}" method="post" enctype="multipart/form-data">
            @csrf
