<x-app-layout>
    ...
    <div class="container" id="report">
        ...
        <table class="table table-striped">
            ...
            @endforeach
                <tr>
                    <td><b>Total</b></td>
                    <td></td>
                    <td><b>{{$sectionClassStudent->sectionClass->totalFee($sectionClassStudent->student->gender)}}</b></td>
                </tr>
            </tbody>
        </table>
        </div>
        ...
        <div class="col-md-12">
            <p style="color:black; line-height: 2.5;">The payment of <b>#{{$sectionClassStudent->paidAmount($term)}}</b> out of <b>#{{$sectionClassStudent->sectionClass->totalFee($sectionClassStudent->student->gender)}}</b> been recieved in the school
             for the above scholar  as {{$sectionClassStudent->feeAmount($term)-$sectionClassStudent->paidAmount($term)>0 ? 'Installment' : 'Complete'}} payment.</p>
