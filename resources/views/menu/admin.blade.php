<li><a href="{{route('dashboard.session.index')}}">Calendar <i class="fa fa-home"></i></a></li>
<li><a href="{{route('dashboard.section.index')}}">Sections</a></li>
<li><a href="{{route('dashboard.teacher.index')}}">Teachers</a></li>
<li><a href="{{route('dashboard.student.index')}}">Students</a></li>
